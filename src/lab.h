...
/**
 * The smallest memory block size that can be returned by buddy_malloc value
 * must be large enough to account for the avail header.
 */
#define SMALLEST_K 6
...
/**
 * Find the buddy of a given pointer and kval relative to the base address we
 * got from mmap
